...
namespace NPS.ID.PublicApi.Client.Connection
{
    public static class StompMessageFactory
    {
        ...
        {
            return CreateFrame(StompCommandConstants.Send, new Dictionary<string, string>()
            {
        ...
        {
            return CreateFrame(StompCommandConstants.Subscribe, new Dictionary<string, string>()
            {
                {DestinationHeader, destination},
        ...
        {
            return CreateFrame(StompCommandConstants.Unsubscribe, new Dictionary<string, string>()
            {
                {DestinationHeader, destination},
                {SubscriptionIdHeader, id}
            });
