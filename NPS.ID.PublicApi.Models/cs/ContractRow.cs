...
namespace NPS.ID.PublicApi.Models.Generated
{
    ...
    public partial class DeliveryAreaState 
    {
        ...
        /// <summary>Validity start time for contract in the area</summary>
        [Newtonsoft.Json.JsonProperty("openAt", Required = Newtonsoft.Json.Required.Always)]
        [System.ComponentModel.DataAnnotations.Required]
        public System.DateTimeOffset OpenAt { get; set; }
    
        /// <summary>Validity close time for contract in the area</summary>
    ...
    public partial class ContractRow 
    {
        ...
        /// <summary>The total duration of this contract in seconds e.g. hourly contracts have a duration of 3600 seconds.</summary>
        [Newtonsoft.Json.JsonProperty("durationSeconds", Required = Newtonsoft.Json.Required.Always)]
        public int DurationSeconds { get; set; }
    
        /// <summary>The minimum resolution of this contract in seconds e.g 15 minute resolution will be 900 seconds.</summary>
        ...
        /// <summary>The delivery start for this contract</summary>
        ...
        /// <summary>The delivery end for this contract</summary>
